...
namespace Filter\Vendor\StellarWP\Telemetry;

use Filter\Vendor\StellarWP\ContainerContract\ContainerInterface;
use Filter\Vendor\StellarWP\Telemetry\Admin\Admin_Subscriber;
use Filter\Vendor\StellarWP\Telemetry\Admin\Resources;
use Filter\Vendor\StellarWP\Telemetry\Contracts\Data_Provider;
use Filter\Vendor\StellarWP\Telemetry\Data_Providers\Debug_Data;
use Filter\Vendor\StellarWP\Telemetry\Events\Event_Subscriber;
use Filter\Vendor\StellarWP\Telemetry\Exit_Interview\Exit_Interview_Subscriber;
use Filter\Vendor\StellarWP\Telemetry\Exit_Interview\Template;
use Filter\Vendor\StellarWP\Telemetry\Last_Send\Last_Send;
use Filter\Vendor\StellarWP\Telemetry\Last_Send\Last_Send_Subscriber;
use Filter\Vendor\StellarWP\Telemetry\Opt_In\Opt_In_Subscriber;
use Filter\Vendor\StellarWP\Telemetry\Opt_In\Opt_In_Template;
use Filter\Vendor\StellarWP\Telemetry\Opt_In\Status;
use Filter\Vendor\StellarWP\Telemetry\Telemetry\Telemetry;
use Filter\Vendor\StellarWP\Telemetry\Telemetry\Telemetry_Subscriber;
...
class Core {
	 ...
	 * @since 1.0.0
	 *
	 * @return \Filter\Vendor\StellarWP\ContainerContract\ContainerInterface
	 */
