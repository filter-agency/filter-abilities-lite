...
namespace Filter\Vendor\StellarWP\Telemetry\Exit_Interview;
...
use Filter\Vendor\StellarWP\Telemetry\Contracts\Template_Interface;
...
class Template implements Template_Interface {
	 ...
	 * @since 1.0.0
	 *
	 * @var \Filter\Vendor\StellarWP\ContainerContract\ContainerInterface
	 */
	protected $container;
	 ...
	 * @since 1.0.0
	 *
	 * @param \Filter\Vendor\StellarWP\ContainerContract\ContainerInterface $container The container.
	 */
